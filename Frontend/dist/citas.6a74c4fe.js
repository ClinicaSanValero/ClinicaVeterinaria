...
})({"gU4Hr":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "012d99b06a74c4fe";
"use strict";
...
},{}],"ljCc8":[function(require,module,exports,__globalThis) {
...
window.actualizarFormularioCita = function(id) {
    (0, _axiosDefault.default).get(`http://localhost:8080/citas/${id}`).then((response)=>{
        ...
        const contenedorFormulario = (0, _documentsUtilJs.el)('edit-appointment-container') || document.createElement('div');
...
window.guardarCita = function(id) {
    const formulario = (0, _documentsUtilJs.el)('appointment-form');
    ...
    (0, _axiosDefault.default).put(`http://localhost:8080/citas/${id}`, citaActualizada).then(()=>{
        (0, _documentsUtilJs.notifyOk)('Appointment successfully updated');
        cerrarFormulario();
        window.location.reload();
    }).catch(()=>(0, _documentsUtilJs.notifyError)('Error updating the appointment'));
};
window.cerrarFormulario = function() {
    const contenedorFormulario = (0, _documentsUtilJs.el)('edit-appointment-container');
    if (contenedorFormulario) contenedorFormulario.remove();
};

},{"axios":"jo6P5","./documentsUtil.js":"4ohqe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gU4Hr","ljCc8"], "ljCc8", "parcelRequire94c2")

//# sourceMappingURL=citas.6a74c4fe.js.map
